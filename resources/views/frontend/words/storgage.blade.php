...
@section('title','Word Storgage Page')
...
@section('body_class', 'word-storgage-page')
    ...
    <div class="col-md-9">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h1 class="text-center">Words Storgage</h1>
            </div>
    ...
    <div class="col-md-3">
        <div class="ibox-content">
            ...
            <ul class="folder-list sidebar-list" style="padding: 0">
                ...
                <li class="active"><a href="/word/storgage"><i class="fa fa-hand-o-right"></i> Words storgage</a></li>
                <li>
